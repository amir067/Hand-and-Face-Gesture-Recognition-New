...
public class STT extends AppCompatActivity implements SpeechDelegate {
    private static final String TAG = "STT";

    private final int PERMISSIONS_REQUEST = 1;
    private static final String LOG_TAG = STT.class.getSimpleName();
...
//        getSupportActionBar().hide();
    ...
    private void onSetSpeechToTextLanguage() {
        Speech.getInstance().getSupportedSpeechToTextLanguages(new SupportedLanguagesListener() {
            ...
            public void onSupportedLanguages(List<String> supportedLanguages) {
                ...
                new AlertDialog.Builder( STT.this)
                        ...
                        .setItems(items, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Toast.makeText(STT.this, "Selected: " + items[i], Toast.LENGTH_LONG).show();
                            }
                        })
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if (requestCode != PERMISSIONS_REQUEST) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(STT.this, R.string.permission_required, Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    private void onRecordAudioPermissionGranted() {
        ...
        try {
            ...
            Speech.getInstance().startListening(progress, STT.this);
    ...
    private void loadWeb(String string) {
        ...
        Toasty.info(STT.this,"Wait", Toasty.LENGTH_SHORT).show();

        webView.setVisibility(View.VISIBLE);
        //String string1 = getResources().getString(R.string.web_view_domain1);
        //String string2 = getResources().getString(R.string.web_view_domain2);
        ...
        //webView.loadUrl("https://www.google.com/"+string+"+images");//
        //webView.loadUrl(string1+string+string2);//
        //Log.e(TAG, "loadWeb: address parsing: "+string1+string+string2 );
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    case DialogInterface.BUTTON_POSITIVE:
                        SpeechUtil.redirectUserToGoogleAppOnPlayStore(STT.this);
                        break;
